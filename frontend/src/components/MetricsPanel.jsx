    ...
    return (
        <div className="bg-slate-900/60 rounded-2xl shadow-xl p-6 border border-slate-800">
            ...
            <div className="space-y-1 text-sm">
                ...
                <div className="flex items-center justify-between">
                    <span className="text-slate-400">Precision (weighted)</span>
                    <span className="font-semibold text-slate-100">{pct(metrics?.precision_weighted)}</span>
                </div>
                <div className="flex items-center justify-between">
                    <span className="text-slate-400">Recall (weighted)</span>
            ...
            {!compact && perClass && (
                <div className="mt-5">
                    <p className="text-sm font-semibold text-slate-200 mb-2">Per-class (P/R/F1)</p>
